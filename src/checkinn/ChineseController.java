...
public class ChineseController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(ChineseController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @FXML
    private void Dumpling(ActionEvent event) throws IOException {
    ...
    @FXML
    private void soup(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void duck(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void shredChicken(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void bubbleTea(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void fish(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void friedrice(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
    ...
    @FXML
    private void roll(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddProductDetails.fxml"));
        Parent root4 = (Parent) fxmlLoader.load();
        AddProductDetailsController scene2 = fxmlLoader.getController();
